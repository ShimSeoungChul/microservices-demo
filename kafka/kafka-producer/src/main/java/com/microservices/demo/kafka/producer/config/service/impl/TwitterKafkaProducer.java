...
public class TwitterKafkaProducer implements KafkaProducer<Long, TwitterAvroModel> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TwitterKafkaProducer.class.getName());
    ...
    public void send(String topicName, Long key, TwitterAvroModel value) {
        ...
        addCallback(topicName, value, kafkaResultFuture);
    }
    ...
    private void addCallback(String topicName, TwitterAvroModel message,
        ...
        kafkaResultFuture.addCallback(new ListenableFutureCallback<>() {
            ...
            public void onSuccess(SendResult<Long, TwitterAvroModel> result) {
                ...
                LOG.info("Received new metadata. Topic: {}; Partition: {}; Offset: {}; Timestamp: {}; Time: {}",
                        metadata.topic(),
                        metadata.partition(),
                        metadata.offset(),
                        metadata.timestamp(),
